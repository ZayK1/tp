...
public class LogicManagerTest {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + STUDENT_ID_DESC_AMY
                + EMAIL_DESC_AMY + MODULE_CODE_DESC_AMY;
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withStudentId(VALID_STUDENT_ID_AMY)
                .withEmail(VALID_EMAIL_AMY).withModuleCodes(VALID_MODULE_CODE_AMY).withTags().build();
