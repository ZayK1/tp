...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withStudentId(VALID_STUDENT_ID_BOB)
                .withEmail(VALID_EMAIL_BOB).withModuleCodes(VALID_MODULE_CODE_BOB)
        ...
        Person expectedPersonMultipleTags = new PersonBuilder().withName(VALID_NAME_BOB)
                ...
                .withModuleCodes(VALID_MODULE_CODE_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build();
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_BOB + TAG_DESC_FRIEND;
        ...
        assertParseFailure(parser,
                validExpectedPersonString + STUDENT_ID_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_STUDENT_ID_BOB + VALID_EMAIL_BOB + VALID_MODULE_CODE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);
